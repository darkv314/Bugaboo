...
function SignUpForm() {
  ...
  return (
    <div className="relative flex flex-col rounded-2xl items-center bg-white/80 w-5/6 xs:w-7/12 sm:w-1/2 md:w-2/5 lg:w-[32%] m-4 py-12 px-12 gap-2">
      <h1 className="text-3xl text-black font-extrabold font-cabin">Sign Up</h1>
      <FormProvider {...methods}>
        ...
        >
          ...
          <CustomButton disable={signUpMutation.isLoading} theme="secondary">
            <LoadingLabel message="Sign Up" state={signUpMutation.isLoading} />
          </CustomButton>
        </form>
      </FormProvider>
